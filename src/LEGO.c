...
int main (int argc, char *argv[]) {	
	...
	boolean *intG;
	int i,nodeNum,gsNum,intSize,intSize_net;
...
// read in interesting gene list and calculate ES
	...
	LEGOout_int_file(intG,intSize,intSize_net,gsNum,geneset_min,geneset_max,output_ES_file,input_NW_file,input_CS_file,input_GS_file);
