...
int main (int argc, char *argv[]) {	
	...
	boolean **intG,*bgG;
	int intNum,*intGNum,*intGNum_net,bgSize,bgSize_net;
...
// read in interesting gene list and calculate ES
	...
	LEGOout_int_mul_bg_file(intG,bgG,intGNum,intGNum_net,bgSize,bgSize_net,intNum,gsNum,geneset_min,geneset_max,output_ES_file,input_NW_file,input_CS_file,input_GS_file);
